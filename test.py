...
class MyMainWindow(QMainWindow, Ui_MainWindow):
    ...
    def _init_ui(self):
        ...
        self.IP_lineEdit.setText("10.113.217.253")
        self.Port_lineEdit.setText("554")
        self.Name_lineEdit.setText("sang")
        self.Pwd_lineEdit.setText("SaNg080498.")
    ...
    def play_btn_onclick(self):
        if not self.playID:
            ...
            self.playID = self.sdk.RealPlayEx(
                self.loginID, channel, self.PlayWnd.winId(), stream_type
            )
            if self.playID != 0:
